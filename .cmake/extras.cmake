...
if(CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_GNUCXX)
    ...
    add_custom_target(coverage
        ...
        COMMAND gcovr . -r ${CMAKE_SOURCE_DIR} --html-details --html -o coverage/index.html -e ${CMAKE_SOURCE_DIR}/test/catch.hpp -e ${CMAKE_BINARY_DIR}/third_party/*;
        COMMAND gcovr . -r ${CMAKE_SOURCE_DIR} --xml -o coverage/report.xml -e ${CMAKE_SOURCE_DIR}/test/catch.hpp  -e ${CMAKE_BINARY_DIR}/third_party/*;
        COMMAND gcovr . -r ${CMAKE_SOURCE_DIR} -o coverage/report.txt -e ${CMAKE_SOURCE_DIR}/test/catch.hpp  -e ${CMAKE_BINARY_DIR}/third_party/*;
